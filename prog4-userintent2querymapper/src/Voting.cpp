...
void Voting::selectPortion()
{
    section += "\n";
	cout << "Would you like to print the whole Voting section or are you looking for something in particular?" << endl;
